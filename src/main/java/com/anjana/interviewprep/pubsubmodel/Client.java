package com.anjana.interviewprep.pubsubmodel;

import com.anjana.interviewprep.pubsubmodel.model.*;
import com.anjana.interviewprep.pubsubmodel.repository.PubSubService;

public class Client {

    public static void main(String[] args) {
        IPublisher javaPublisher = new Publisher();
        Publisher pythonPublisher = new Publisher();

        ISubscriber javaSubscriber = new Subscriber();
        ISubscriber allLanguagesSubscriber = new Subscriber();
        ISubscriber pythonSubscriber = new Subscriber();
